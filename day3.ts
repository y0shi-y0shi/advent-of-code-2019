...
const intersection = (line1: number[][], line2: number[][]): number[][] => {
    const result: number[][] = [];
...
const manhattanDistance = (locations: number[][]): number => {
...
const leastSteps = (locations: number[][], line1: number[][], line2: number[][]): number => {
    let result: number = Infinity;
